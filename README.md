...
So, it may be better to have the user explicitly confirm the artist using disambiguation information. Though needs more testing -- if I can't find any examples, may just forget it.
